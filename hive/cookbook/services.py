...
class Services(ApiManager):
    ...
    def services_last_status_v3_query(self, warm_start: bool = False,
        single_page: bool = False, page_size: int = 5000,
        kwargs: dict = None, **params) -> list:
        """Service Query Last Status V3
        ...
        params.get('extract_data_profile'), params.get('sort_by'), params.get(
            ...
            'count')
        if not self._silence_warning:
            warning_wrong_parameters(self.services_last_status_v3_query.
                __name__, params, official_params_list)
        response = self.execute('GET', path=
            f'/services/query/last_status_v3', single_page=single_page,
            page_size=page_size, warm_start=warm_start, params=params, **kwargs
            )
        return response
    ...
    def last_status_bulk(self, payload: dict = False,
        warm_start: bool = False, single_page: bool = False,
        page_size: int = 5000, kwargs: dict = None, **params) -> list:
        """Service Query Last Status List V3
    ...
    def services_last_status_v3_extended_query(self,
        warm_start: bool = False, single_page: bool = False,
        page_size: int = 5000, kwargs: dict = None, **params) -> list:
        """Service Query Last Status V3 Extended
        ...
        if not self._silence_warning:
            warning_wrong_parameters(self.
                services_last_status_v3_extended_query.__name__, params,
                official_params_list)
        response = self.execute('GET', path=
            f'/services/query/last_status_v3_extended', single_page=
            single_page, page_size=page_size, warm_start=warm_start, params
            =params, **kwargs)
        return response
