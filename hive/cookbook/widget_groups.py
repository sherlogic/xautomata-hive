...
class WidgetGroups(ApiManager):
    ...
    def widget_groups_users_create_bulk(self, payload: list,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None,
        **params) -> list:
        """Bulk Link Users
        ...
        if not self._silence_warning:
            warning_wrong_parameters(self.widget_groups_users_create_bulk.
                __name__, params, official_params_list)
        response = self.execute('POST', path=
            f'/widget_groups/bulk/create/users', single_page=single_page,
            page_size=page_size, params=params, payload=payload, **kwargs)
        return response

    def widget_groups_users_delete_bulk(self, payload: list,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None
        ) -> list:
        """Bulk Unlink Users
        ...
        if kwargs is None:
            kwargs = dict()
        response = self.execute('POST', path=
            f'/widget_groups/bulk/delete/users', single_page=single_page,
            page_size=page_size, payload=payload, **kwargs)
        return response

    def widget_groups_widgets_create_bulk(self, payload: list,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None,
        **params) -> list:
        """Bulk Link Widgets
        ...
        params.get('best_effort')
        if not self._silence_warning:
            warning_wrong_parameters(self.widget_groups_widgets_create_bulk
                .__name__, params, official_params_list)
        response = self.execute('POST', path=
            f'/widget_groups/bulk/create/widgets', single_page=single_page,
            page_size=page_size, params=params, payload=payload, **kwargs)
        return response

    def widget_groups_widgets_delete_bulk(self, payload: list,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None
        ) -> list:
        """Bulk Unlink Widgets
        ...
        if kwargs is None:
            kwargs = dict()
        response = self.execute('POST', path=
            f'/widget_groups/bulk/delete/widgets', single_page=single_page,
            page_size=page_size, payload=payload, **kwargs)
        return response
