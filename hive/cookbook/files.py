...
class Files(ApiManager):
    ...
    def files_bulk(self, payload: list, warm_start: bool = False,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None,
        **params) -> list:
        """Bulk Read User Files
        ...
        params.get('join')
        if not self._silence_warning:
            warning_wrong_parameters(self.files_bulk.__name__, params,
                official_params_list)
        response = self.execute('POST', path=f'/files/bulk/read/',
            single_page=single_page, page_size=page_size, warm_start=
            warm_start, params=params, payload=payload, **kwargs)
        return response

    def files_read_by_bulk(self, payload: list, warm_start: bool = False,
        single_page: bool = False, page_size: int = 50, kwargs: dict = None,
        **params) -> list:
        """Bulk Read By Name
        ...
        params.get('join')
        if not self._silence_warning:
            warning_wrong_parameters(self.files_read_by_bulk.__name__,
                params, official_params_list)
        response = self.execute('POST', path=f'/files/bulk/read_by/',
            single_page=single_page, page_size=page_size, warm_start=
            warm_start, params=params, payload=payload, **kwargs)
        return response
